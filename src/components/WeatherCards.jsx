...
const WeatherCards = ({daily=[]}) => (
    <div className='comp-weatherCards flex flex-col px-3 mx-auto lg:flex-row space-y-4 lg:space-y-0 lg:justify-center lg:space-x-4'>
            {daily.map((day, i) => 
                <div 
                key={day.EpochDate + i} 
                className='bg-gray-700 rounded-md p-4 text-gray-400 text-center text-xl w-full flex lg:flex-col justify-between lg:h-56 lg:w-auto'>
                    ...
                    <img src={requestImageFile(`./weather-icons/${day.Day.Icon}.png`).default} alt="weather icon" className='h-24'/>
